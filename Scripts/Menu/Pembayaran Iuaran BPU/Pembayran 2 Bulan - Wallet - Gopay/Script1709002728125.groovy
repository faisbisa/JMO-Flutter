...
Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.widget.RadioButton2Bulan'), 0)
...
Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.view.VE-Wallet'), 0)

Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.widget.IGopay'), 0)
