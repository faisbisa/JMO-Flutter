...
Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.view.VAutodebet'), 0)

Mobile.tap(findTestObject('menu/PembayaranIuranBPU/AutoDebet/android.widget.IShopeepay'), 0)
...
Mobile.tap(findTestObject('menu/PembayaranIuranBPU/mobileBanking/android.view.VSetuju'), 0)
