...
Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.widget.RadioButton3Bulan'), 0)
...
Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.widget.IOvo'), 0)
