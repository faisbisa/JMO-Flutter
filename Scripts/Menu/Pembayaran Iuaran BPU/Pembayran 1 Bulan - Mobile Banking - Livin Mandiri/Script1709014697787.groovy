...
Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.view.VMobilebanking'), 0)

Mobile.tap(findTestObject('menu/PembayaranIuranBPU/mobileBanking/android.widget.ILivinMandiri'), 0)
