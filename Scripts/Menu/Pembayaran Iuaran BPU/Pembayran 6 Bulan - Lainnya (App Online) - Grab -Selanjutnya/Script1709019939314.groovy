...
Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.widget.RadioButton6Bulan'), 0)
...
Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.view.VLainnyaAppOnline'), 0)

Mobile.tap(findTestObject('menu/PembayaranIuranBPU/Lainnya (Aplikasi Online)/android.widget.IGrab'), 0)
...
Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.view.VStatusPembayaran'), 0)

Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.widget.ISemuaKPJ'), 0)

Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.widget.CheckBoxPU'), 0)

Mobile.tap(findTestObject('menu/PembayaranIuranBPU/android.view.VSimpan'), 0)
