...
Mobile.tap(findTestObject('Profil-UbahKontak/Profile-Biometrik/android.widget.SLoginBiometrikSwipe'), 0)

Mobile.setText(findTestObject('Profil-UbahKontak/Profile-Biometrik/android.widget.EMasukkanKataSandi'), 'Welcome2#', 0)

Mobile.tap(findTestObject('Profil-UbahKontak/Profile-Biometrik/android.view.VLanjutKonfirmasiSidikJari'), 0)

WebUI.delay(3)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('Profil-UbahKontak/Profile-Biometrik/android.widget.IbackLoginBiometrik'), 0)
