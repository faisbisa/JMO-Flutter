...
Mobile.tap(findTestObject('Profil-UbahKontak/Profile-Bahasa/android.view.VKlikEnglish'), 0)

WebUI.delay(3)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('Profil-UbahKontak/Profile-Bahasa/android.widget.ILogoutKhususEng'), 0)
