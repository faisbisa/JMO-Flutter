...
Mobile.tap(findTestObject('Profil-UbahKontak/Profile-KebijakandanPrivasi/android.widget.IKebijakandanPrifasi'), 0)

WebUI.delay(3)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('Profil-UbahKontak/Profile-KebijakandanPrivasi/android.widget.IbackKebijakandanPrivasi'), 0)
