...
Mobile.tap(findTestObject('Login/android.widget.IklikJMO'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Profil-UbahKontak/android.view.VKlikMasuk'), 0)

WebUI.delay(10)

Mobile.tap(findTestObject('ProgramPensiun/android.view.VJanimanPensiun'), 0)
...
Mobile.tap(findTestObject('ProgramPensiun/android.view.VPengajuanKalim'), 0)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('ProgramPensiun/android.widget.IKlikMencapaiUsiaPensiun'), 0)

Mobile.tap(findTestObject('ProgramPensiun/android.view.VUsiaPensiunPKB'), 0)

Mobile.takeScreenshot()

WebUI.delay(3)

Mobile.tap(findTestObject('ProgramPensiun/android.widget.IKlikPKBPerusahaan'), 0)

Mobile.tap(findTestObject('ProgramPensiun/android.view.VPilihPKWT'), 0)

Mobile.takeScreenshot()

WebUI.delay(3)

Mobile.tap(findTestObject('ProgramJKK/android.widget.IKlikBack1'), 0)
