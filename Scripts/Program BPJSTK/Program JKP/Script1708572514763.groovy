...
Mobile.tap(findTestObject('ProgramJaminanKehilanganPekerjaan/android.view.VJaminanKehilanganPekerjaan'), 0)
...
Mobile.tap(findTestObject('ProgramJaminanKehilanganPekerjaan/android.view.VKlikKriteriaPenerima'), 0)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('ProgramJaminanKehilanganPekerjaan/android.view.VSyaratpengajuanKalim'), 0)
