...
Mobile.tap(findTestObject('ProgramJaminanKematian/android.view.VPilihJKM'), 0)

Mobile.tap(findTestObject('ProgramJHT/android.widget.IPelajariSelengkapnya'), 0)

Mobile.tap(findTestObject('ProgramJaminanKematian/android.view.VKlikKlaimBeasiswa'), 0)
