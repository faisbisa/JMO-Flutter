...
Mobile.tap(findTestObject('ProgramJKK/android.view.VPilihJKK'), 0)
...
Mobile.tap(findTestObject('ProgramJKK/android.view.VKlikPengajuanKalim'), 0)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('ProgramJKK/android.view.VKlikPembayaranIuran'), 0)
